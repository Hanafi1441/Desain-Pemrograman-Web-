...
$sql =  "SELECT * FROM data";//query memanggil tabel data
$data = $conn->query($sql);// koneksi sql
?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 mb-5">
                <h4>Input Data</h4>
                <!-- memanggil read_message untuk membaca notif -->
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <!-- button untuk masuk ke update form -->
