...
$kelas = ['SE03A','SE03B', 'SE03C'];//array data
$sql =  "SELECT * FROM data";// Query menampilkan data dari tabel data
$data = $conn->query($sql);// koneksi dengan sql

$sql_mahasiswa = "SELECT * FROM data WHERE id=".$_GET['mahasiswa_id'];//mengambil data dengan kolom id
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 mb-5">
                <h4>Input Data</h4>
                <!-- memanggil read_message untuk membaca notif yang masuk -->
                ...
                <div class="card mb-2">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <!-- tombol untuk menhapus data -->
                                <a class="float-right ml-3 text-danger"
                                href="hapus_data.php?mahasiswa_id=<?php 
                                echo $dt['id'] ?> " type="button"
                                class="close"> 
                                    <span class="fa fa-trash"></span>
                                </a>
                                <!-- tombol untuk masuk ke update form -->
                                <a class="float-right ml-3 text-success"
                                
                                href="update_form.php?mahasiswa_id=<?php 
                                echo $dt['id'] ?> " type="button"
                                class="close"> 
